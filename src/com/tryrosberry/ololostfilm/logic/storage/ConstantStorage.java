...
public class ConstantStorage {
    ...
    public static final String BASE_URL = "http://www.lostfilm.tv";
    public static final String RSS_URL = "/rssdd.xml";
    public static final String IMAGES_FOLDER_FOR_CACHE = "pictures";
}
