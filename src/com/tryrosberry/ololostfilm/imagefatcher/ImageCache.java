...
public class ImageCache {
    ...
    /**
     * get exemplar of file by URL if it is loaded and if you need.
     * check by file.canRead() for normal file existence.
     * */
    public File getFile(String url){
        return new File(mCacheParams.diskCacheDir,hashKeyForDisk(url));
    }


    /**
     * get if image is loaded
     * */
    public boolean isFileLoaded(String url){
        return new File(mCacheParams.diskCacheDir,hashKeyForDisk(url)).canRead();
    }
