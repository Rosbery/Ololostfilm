...
public class NewsDetailFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.news_details,null);
        mContainer = (LinearLayout) v.findViewById(R.id.newsContent);
        ((TextView)v.findViewById(R.id.newsDetTitle)).setText(Html.fromHtml(title));
