package com.tryrosberry.ololostfilm.imagefatcher;
...
import com.tryrosberry.ololostfilm.BuildConfig;
...
public abstract class ImageWorker {
    ...
    public void loadImage(Object data, ImageView imageView){
        loadImage(data, imageView,0);
    }

    public void loadCornerImage(Object data, ImageView imageView,int roundPix){
        loadImage(data, imageView,roundPix);
     ...
     */
    private void loadImage(Object data, ImageView imageView, int roundPix) {
        if (data == null) {
            return;
        }
        ...
        if (bitmap != null) {
            ...
            if(roundPix != 0) bitmap = Utils.getRoundedCornerBitmap(bitmap,roundPix);
            imageView.setImageBitmap(bitmap);
        } else if (cancelPotentialWork(data, imageView)) {
            final BitmapWorkerTask task = new BitmapWorkerTask(imageView,roundPix);
    ...
    /**
     * return exemplar of ImageCache to get public access to bitmaps anf files
     */
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        private int cornerPix = 0;

        public BitmapWorkerTask(ImageView imageView,int cornerPix) {
            imageViewReference = new WeakReference<ImageView>(imageView);
            this.cornerPix = cornerPix;
        }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (bitmap != null && imageView != null) {
                ...
                if(cornerPix != 0) bitmap = Utils.getRoundedCornerBitmap(bitmap,cornerPix);
